...
async function processMessage(msg: Message, endpoint: Endpoint) {
  try {
    ...
    else if (msg.header.type == "SbAdvertiseRequest") handleAdvertiseRequest(msg, endpoint)
...
function handleForward(msg: Message, fromEndpoint: Endpoint) {
...
function handleServiceRequest(msg: Message, endpoint: Endpoint) {
...
function handleStatusRequest(msg: Message, endpoint: Endpoint) {
  const status = {
...
function handleEndpointStatusRequest(msg: Message, endpoint: Endpoint) {
...
function handleEndpointWaitRequest(msg: Message, waiterEndpoint: Endpoint) {
